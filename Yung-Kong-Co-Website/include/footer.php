				...
				<div class="col-sm-4 footer-block">
					<div class="footer-widget widget_text">
						...
						<p>
							...
							<a href="products.php#building_materials_category.jpg">		<i class="bi bi-house-door-fill">	</i>Building Materials </a></br>
							<a href="products.php#bolts_fasteners_category.jpg">		<i class="bi bi-nut-fill">			</i>Bolts & Fasteners </a></br>
							<a href="products.php#hand_tools_category.jpg">				<i class="bi bi-wrench">			</i>Hand Tools </a></br>
							<a href="products.php#general_household_category.jpg">		<i class="bi bi-ladder">			</i>General & Household </a></br>
							<a href="products.php#welding_machinery_category.jpg">		<i class="bi bi-door-open-fill">	</i>Welding & Machinery </a></br>
							<a href="products.php#safety_security_category.jpg">		<i class="bi bi-lock-fill">			</i>Safety & Security </a></br>
							<a href="products.php#electrical_accessories_category.jpg">	<i class="bi bi-lightning-fill">	</i>Electrical Accessories </a></br>
							<a href="products.php#plumbing_category.jpg">				<i class="bi bi-battery-full">		</i>Plumbing </a></br>
							<a href="products.php#power_tools_category.jpg">			<i class="bi bi-plug-fill">			</i>Power Tools </a></br>
	...
	<div class="copyright-section">
		<div class="container clearfix">
			...
			<ul class="list-inline pull-right">
				...
				<?php echo ($current_page == 'index.php' ? '<li class="active">' : '<li>') ?><a href="index.php">Home</a>
				</li>
