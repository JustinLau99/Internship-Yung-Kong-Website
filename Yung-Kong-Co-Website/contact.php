		...
		<div class="uc-mobile-menu-pusher">
			...
			<div class="content-wrapper">
				...
				<section class="contact-form ptb-100">
					<div class="container text-center">
						<h2>Compellingly implement distinctive outsourcing<br>and 24/365 customer service
							energistically.</h2>
									...
									<div class="row">
										<div class="col-md-6">
											<div class="form-group user-name">
												...
												<input type="text" class="form-control" required="" id="nameFive-first"
													placeholder="First Name">
											</div>

											<div class="form-group user-email">
												<label for="emailFive" class="sr-only">Email</label>
												<input type="email" class="form-control" required="" id="emailFive"
											...
											<div class="form-group user-phone">
												...
												<input type="text" class="form-control" required="" id="websiteOne"
													placeholder="Phone">
											</div>
										</div><!-- /.col-md-6 -->
										<div class="col-md-6">
											<div class="form-group user-message">
												...
												<textarea class="form-control" required="" id="messageOne"
